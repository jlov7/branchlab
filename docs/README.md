# BranchLab Documentation Hub

Use this page as the canonical map for product, engineering, operations, and release materials.

## Read By Audience

| Audience | Start Here | Then Read |
|---|---|---|
| Executives and non-technical stakeholders | [NON_TECHNICAL_OVERVIEW.md](NON_TECHNICAL_OVERVIEW.md) | [DEMO_SCRIPT.md](DEMO_SCRIPT.md), [RELEASE_REPORT.md](RELEASE_REPORT.md) |
...
- [EVAL_AND_SCORING.md](EVAL_AND_SCORING.md)
...
- [FRONTEND_STYLE_GUIDE.md](FRONTEND_STYLE_GUIDE.md)
- [SCREENSHOT_GALLERY.md](SCREENSHOT_GALLERY.md)
- [ACCESSIBILITY_AUDIT.md](ACCESSIBILITY_AUDIT.md)
- [visual-verification-protocol.md](visual-verification-protocol.md)
- [FRONTEND_SCORECARD.md](FRONTEND_SCORECARD.md)
- [UX_AUDIT_WORLD_CLASS.md](UX_AUDIT_WORLD_CLASS.md)
...
- [plans/2026-02-27-branchlab-implementation.md](plans/2026-02-27-branchlab-implementation.md)
- [plans/2026-03-03-release-readiness-master.md](plans/2026-03-03-release-readiness-master.md)
- [plans/2026-03-03-frontend-100-master-plan.md](plans/2026-03-03-frontend-100-master-plan.md)

## Visual Assets

- Architecture diagram: `assets/diagrams/architecture.svg`
- Journey diagram: `assets/diagrams/ux_flow.svg`
